Graphs of CO2 Monitor values in different scenarios (We used Ardu Spreadsheets tool to save data as csv using seraial monitor and then imported in google sheets to plot the same).
